#!/bin/bash
# Note, this is copied from https://exchange.nagios.org/directory/Plugins/System-Metrics/Memory/Check-mem-%28by-Nestor%40Toronto%29/details
# and hosted locally because wgetting their url was producing an empty file.
